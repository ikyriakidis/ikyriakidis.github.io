...
date: 2019-02-13
description: Installing Plex on a Synology NAS with Docker, step by step: registry pull, volumes, ports and environment settings.
tags: docker, plex, synology
---

## Why Plex, Why Synology and Why Docker?
I find [PLex](/blog/plex/) an easy to use and maintain solution for managing and viewing my media files. I am also a big fan of [Synology](/blog/synology/) mainly because of the simplicity and ease of use. When it comes to Docker, lets say that I like abstracting and Docker makes my life easier when it comes to abstracting at the app layer that packages code and dependencies together and keeps them separete from the operating System.
...
![Docker installation screenshot](/assets/blog/plex-installation-synology-docker/Docker.png)
...
![Docker registry search screenshot](/assets/blog/plex-installation-synology-docker/DockerRegistry.png)
...
![Launch plex image screenshot](/assets/blog/plex-installation-synology-docker/DockerLaunch.png)
...
![Docker folder screenshot](/assets/blog/plex-installation-synology-docker/DockerFolder.png)
...
![Docker folder screenshot](/assets/blog/plex-installation-synology-docker/DockerDirectories.png)

### Step 3 - Mapping ports
Map the ports as you want, especially if you have other containers running on the same port.

![Docker ports screenshot](/assets/blog/plex-installation-synology-docker/DockerPorts.png)
...
![Docker environmnet settings screenshot](/assets/blog/plex-installation-synology-docker/DockerEnvironmentSettings.png)
